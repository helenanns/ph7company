...
<section class="grid-icons container">
    <ul class="grid-icons__list">
        <li class="grid-icons__item">
            <?php echo file_get_contents($theme_uri . '/assets/imgicons/home/frete.svg'); ?>
        ...
        <li class="grid-icons__item">
            <?php echo file_get_contents($theme_uri . '/assets/imgicons/home/payment.svg'); ?>
            <div class="grid-icons__item__content">
        ...
        <li class="grid-icons__item">
            <?php echo file_get_contents($theme_uri . '/assets/imgicons/home/seguranca.svg'); ?>
            <div class="grid-icons__item__content">
